...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template match="*[cda:templateId/@root=&#34;2.16.840.1.113883.10.20.1.48&#34;]" priority="3999"
      ...
      <xsl:choose>
         <xsl:when test="cda:participantRole/cda:id[@root=/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:id/@root]"/>
         <xsl:otherwise>
            <failed-assert id=""
                           test="cda:participantRole/cda:id[@root=/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:id/@root]"
                           role="">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="*[cda:templateId/@root=&#34;2.16.840.1.113883.10.20.1.51&#34;]" priority="3999"
      ...
      <xsl:choose>
         <xsl:when test="cda:templateId[@root='2.16.840.1.113883.10.20.1.51'] or cda:code[@code='33999-4'][@codeSystem='2.16.840.1.113883.6.1']"/>
         <xsl:otherwise>
            <failed-assert id=""
                           test="cda:templateId[@root='2.16.840.1.113883.10.20.1.51'] or cda:code[@code='33999-4'][@codeSystem='2.16.840.1.113883.6.1']"
                           role="">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
