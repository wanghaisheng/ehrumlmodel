    ...
    <xsl:template match="/">
        <ClinicalDocument xmlns="urn:hl7-org:v3"
            ...
            <xsl:call-template name="headerInformation">
                ...
                <xsl:with-param name="displayName" select="'Consultation Summary Document'"/>
                <xsl:with-param name="title" select="'Consultation Summary Document'"/>
                <xsl:with-param name="templateID" select="'2.16.840.1.113883.3.1275.1.1.3'"/>
            </xsl:call-template>
            <component>
                <structuredBody>
                    ...
                    <xsl:call-template name="allergies">
 					...
 					<xsl:if test="fn:exists(toc:ToCSummary/toc:Body/toc:AdvanceDirectives)">
