...
<xsl:stylesheet version="2.0"
  ...
  <xsl:variable name="个人基本信息数据集_Level1" as="xs:string" select="'BS_L1'"/>
  <xsl:variable name="个人基本信息数据集_Level2" as="xs:string" select="'BS_L2'"/>
  <xsl:variable name="个人基本信息数据集_Level3" as="xs:string" select="'BS_L3'"/>    
