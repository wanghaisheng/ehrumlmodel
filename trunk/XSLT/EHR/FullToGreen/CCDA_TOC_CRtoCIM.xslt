...
<xsl:stylesheet version="2.0"
	...
	<xsl:import href="sections/GeneralStatus_ccda_IPToCIM.xslt" />
	...
	<xsl:import href="sections/HistoryofPastIllness_ccda_IPToCIM.xslt" />
	...
	<xsl:import href="sections/PhysicalExamination_ccda_IPToCIM.xslt" />
	...
	<xsl:template match="/">
		...
		<ToCSummary>
			...
			<Body>
				<xsl:if
					test="($srcMnemonic and ($srcMnemonic=$TOCConsultationRequest_Level1))">
					<xsl:if
				...
				<xsl:if
					test="($srcMnemonic and ($srcMnemonic=$TOCConsultationRequest_Level2)) or ($srcMnemonic and ($srcMnemonic=$TOCConsultationRequest_Level3))">
					...
					<xsl:if test="fn:exists(cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.22.2.20'])">
						<xsl:call-template name="historyofPastIllnessSectionCCDA">
							<xsl:with-param name="historyofPastIllnessSection"
								select="cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.22.2.20']" />
								<xsl:with-param name="srcMnemonic" select="$srcMnemonic" />
						</xsl:call-template>
					</xsl:if>
					
						<!--  General Status-->
					<xsl:if test="fn:exists(cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.2.5'])">
						<xsl:call-template name="generalStatusSectionCCDA">
							<xsl:with-param name="generalStatusSection"
								select="cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.2.5']" />
								<xsl:with-param name="srcMnemonic" select="$srcMnemonic" />
						</xsl:call-template>
					</xsl:if>
					
					<!--  Physical Examination -->
					<xsl:if test="fn:exists(cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.2.10'])">
						<xsl:call-template name="physicalExaminationSectionCCDA">
							<xsl:with-param name="physicalExaminationSection"
								select="cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.2.10']" />
								<xsl:with-param name="srcMnemonic" select="$srcMnemonic" />
						</xsl:call-template>
					</xsl:if>
