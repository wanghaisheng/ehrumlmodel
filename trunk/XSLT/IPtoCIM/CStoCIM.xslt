<?xml version="1.0" encoding="UTF-8"?>
	...
	<xsl:import href="sections/Medications_IPToCIM.xslt" />
	<xsl:import href="sections/Results_IPToCIM.xslt"/>
	...
	<!-- <xsl:import href="sections/Encounters_IPToCIM.xslt" />
	...
	<xsl:template match="/">
		...
		<ToCSummary>
			<xsl:attribute name="xsi:schemaLocation"
				...
				<xsl:call-template name="medicationsSection">
					<xsl:with-param name="medicationsSection"
						select="cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:templateId/@root='2.16.840.1.113883.3.88.11.83.112']" />
				</xsl:call-template>
				...
				<xsl:call-template name="resultsSection">
					<xsl:with-param name="resultsSection"
						select="cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:templateId/@root='2.16.840.1.113883.3.88.11.83.122']" />
				</xsl:call-template>
				...
				<!-- 
				 <xsl:call-template name="encounterSection">
					<xsl:with-param name="encounterSection"
						select="cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:templateId/@root='2.16.840.1.113883.3.88.11.83.127']" />
				</xsl:call-template>
