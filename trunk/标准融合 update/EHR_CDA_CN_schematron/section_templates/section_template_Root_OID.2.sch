...
<!DOCTYPE schema [
<!ENTITY ent-section_template_Root_OID.2 SYSTEM 'section_template_Root_OID.2.ent'>
]>
...
<phase id='warning'>
	<active pattern='p-section_template_Root_OID.2-warning'/>
</phase>

<phase id='manual'>
	<active pattern='p-section_template_Root_OID.2-manual'/>
</phase>
