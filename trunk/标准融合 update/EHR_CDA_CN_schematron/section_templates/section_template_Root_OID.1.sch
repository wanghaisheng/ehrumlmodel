...
<!DOCTYPE schema [
<!ENTITY ent-section_template_Root_OID.1 SYSTEM 'section_template_Root_OID.1.ent'>
]>
...
<phase id='warning'>
	<active pattern='p-section_template_Root_OID.1-warning'/>
</phase>

<phase id='manual'>
	<active pattern='p-section_template_Root_OID.1-manual'/>
</phase>
